export const homeHTML = `
    ...
    <div class="dashboard-card" data-dashboard="moderation">
        <i class="icon">🛡️</i>
        <h3>Moderation</h3>
    ...
    <div class="dashboard-card" data-dashboard="logging">
        <i class="icon">📜</i>
        <h3>Logging</h3>
